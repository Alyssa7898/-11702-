		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-4 col-md-offset-8">
					...
					<a href="${APP_PATH}/reset" <button id="emp_reset_all_btn" class="btn btn-success">重置</button>></a>
				</div>
			</div>
			<!-- table of data -->
			<div class="row">
		...
		<script type="text/javascript">
			...
			function bulid_emps_table(result) {
				...
				$.each(emps, function(index, item) {
					...
					var edateTd=$("<td></td>").append(item.edate);
					...
					$("<tr></tr>").append(checkBoxTd).append(empIdTd).append(empNameTd).append(
							empGenderTd).append(empEmailTd).append(deptNameTd).append(edateTd)
